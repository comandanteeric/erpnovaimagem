...
const EMPTY_DB = () => ({
  quotes:[], orders:[], clients:[], users:[], disabledUsers:[], products:[], suppliers:[], payables:[], reworks:[],
...
function normalize(parsed={}){
  const base=EMPTY_DB();
  for(const k of ['quotes','orders','clients','users','disabledUsers','products','suppliers','payables','reworks']) base[k]=Array.isArray(parsed[k])?parsed[k]:[];
